...
struct Win32_ComputerSystemProduct {
  ...
  static std::string getWmiClassName() { return "Win32_ComputerSystemProduct"; }
...
struct Win32_ComputerSystem {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "AutomaticManagedPagefile",
                   (*this).AutomaticManagedPagefile);
    result.extract(index, "AutomaticResetBootOption",
                   (*this).AutomaticResetBootOption);
    result.extract(index, "AutomaticResetCapability",
    ...
    result.extract(index, "EnableDaylightSavingsTime",
                   (*this).EnableDaylightSavingsTime);
    result.extract(index, "FrontPanelResetStatus",
    ...
    result.extract(index, "KeyboardPasswordStatus",
    ...
    result.extract(index, "NetworkServerModeEnabled",
                   (*this).NetworkServerModeEnabled);
    result.extract(index, "NumberOfLogicalProcessors",
    ...
    result.extract(index, "PowerManagementCapabilities",
                   (*this).PowerManagementCapabilities);
    result.extract(index, "PowerManagementSupported",
                   (*this).PowerManagementSupported);
    result.extract(index, "PowerOnPasswordStatus",
    ...
    result.extract(index, "SupportContactDescription",
  ...
  static std::string getWmiClassName() { return "Win32_ComputerSystem"; }
...
struct Win32_ParallelPort {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "CapabilityDescriptions",
                   (*this).CapabilityDescriptions);
    result.extract(index, "Caption", (*this).Caption);
    result.extract(index, "ConfigManagerErrorCode",
                   (*this).ConfigManagerErrorCode);
    result.extract(index, "ConfigManagerUserConfig",
                   (*this).ConfigManagerUserConfig);
    result.extract(index, "CreationClassName", (*this).CreationClassName);
    result.extract(index, "Description", (*this).Description);
    ...
    result.extract(index, "SystemCreationClassName",
                   (*this).SystemCreationClassName);
    result.extract(index, "SystemName", (*this).SystemName);
    result.extract(index, "TimeOfLastReset", (*this).TimeOfLastReset);
  }

  static std::string getWmiClassName() { return "Win32_ParallelPort"; }
...
struct Win32_PhysicalMedia {
  ...
  static std::string getWmiClassName() { return "Win32_PhysicalMedia"; }
...
struct Win32_PhysicalMemory {
  ...
  static std::string getWmiClassName() { return "Win32_PhysicalMemory"; }
...
struct Win32_Processor {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "NumberOfLogicalProcessors",
                   (*this).NumberOfLogicalProcessors);
    result.extract(index, "OtherFamilyDescription",
                   (*this).OtherFamilyDescription);
    result.extract(index, "PartNumber", (*this).PartNumber);
    result.extract(index, "PNPDeviceID", (*this).PNPDeviceID);
    result.extract(index, "PowerManagementCapabilities",
                   (*this).PowerManagementCapabilities);
    ...
    result.extract(index, "Version", (*this).Version);
    result.extract(index, "VirtualizationFirmwareEnabled",
                   (*this).VirtualizationFirmwareEnabled);
    result.extract(index, "VMMonitorModeExtensions",
                   (*this).VMMonitorModeExtensions);
    result.extract(index, "VoltageCaps", (*this).VoltageCaps);
  }

  static std::string getWmiClassName() { return "Win32_Processor"; }
...
struct Win32_Service {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "ServiceSpecificExitCode",
  ...
  static std::string getWmiClassName() { return "Win32_Service"; }
...
struct Win32_SerialPort {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "MaximumInputBufferSize",
                   (*this).MaximumInputBufferSize);
    result.extract(index, "MaximumOutputBufferSize",
                   (*this).MaximumOutputBufferSize);
    result.extract(index, "MaxNumberControlled", (*this).MaxNumberControlled);
    result.extract(index, "Name", (*this).Name);
    result.extract(index, "OSAutoDiscovered", (*this).OSAutoDiscovered);
    result.extract(index, "PNPDeviceID", (*this).PNPDeviceID);
    ...
    result.extract(index, "SupportsElapsedTimeouts",
                   (*this).SupportsElapsedTimeouts);
    ...
    result.extract(index, "SupportsSpecialCharacters",
                   (*this).SupportsSpecialCharacters);
  ...
  static std::string getWmiClassName() { return "Win32_SerialPort"; }
...
struct SoftwareLicensingService {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "IsKeyManagementServiceMachine",
                   (*this).IsKeyManagementServiceMachine);
    result.extract(index, "KeyManagementServiceCurrentCount",
                   (*this).KeyManagementServiceCurrentCount);
    result.extract(index, "KeyManagementServiceDnsPublishing",
                   (*this).KeyManagementServiceDnsPublishing);
    result.extract(index, "KeyManagementServiceFailedRequests",
                   (*this).KeyManagementServiceFailedRequests);
    result.extract(index, "KeyManagementServiceHostCaching",
                   (*this).KeyManagementServiceHostCaching);
    result.extract(index, "KeyManagementServiceLicensedRequests",
                   (*this).KeyManagementServiceLicensedRequests);
    result.extract(index, "KeyManagementServiceListeningPort",
                   (*this).KeyManagementServiceListeningPort);
    result.extract(index, "KeyManagementServiceLookupDomain",
                   (*this).KeyManagementServiceLookupDomain);
    result.extract(index, "KeyManagementServiceLowPriority",
                   (*this).KeyManagementServiceLowPriority);
    result.extract(index, "KeyManagementServiceMachine",
                   (*this).KeyManagementServiceMachine);
    ...
    result.extract(index, "KeyManagementServiceOOBGraceRequests",
                   (*this).KeyManagementServiceOOBGraceRequests);
    result.extract(index, "KeyManagementServiceOOTGraceRequests",
                   (*this).KeyManagementServiceOOTGraceRequests);
    result.extract(index, "KeyManagementServicePort",
                   (*this).KeyManagementServicePort);
    result.extract(index, "KeyManagementServiceProductKeyID",
                   (*this).KeyManagementServiceProductKeyID);
    result.extract(index, "KeyManagementServiceTotalRequests",
                   (*this).KeyManagementServiceTotalRequests);
    result.extract(index, "KeyManagementServiceUnlicensedRequests",
                   (*this).KeyManagementServiceUnlicensedRequests);
    result.extract(index, "OA2xBiosMarkerMinorVersion",
                   (*this).OA2xBiosMarkerMinorVersion);
    result.extract(index, "OA2xBiosMarkerStatus", (*this).OA2xBiosMarkerStatus);
    result.extract(index, "OA3xOriginalProductKey",
                   (*this).OA3xOriginalProductKey);
    result.extract(index, "OA3xOriginalProductKeyDescription",
                   (*this).OA3xOriginalProductKeyDescription);
    result.extract(index, "OA3xOriginalProductKeyPkPn",
                   (*this).OA3xOriginalProductKeyPkPn);
    result.extract(index, "PolicyCacheRefreshRequired",
                   (*this).PolicyCacheRefreshRequired);
    result.extract(index, "RemainingWindowsReArmCount",
                   (*this).RemainingWindowsReArmCount);
    result.extract(index, "RequiredClientCount", (*this).RequiredClientCount);
    result.extract(index, "TokenActivationAdditionalInfo",
                   (*this).TokenActivationAdditionalInfo);
    result.extract(index, "TokenActivationCertificateThumbprint",
                   (*this).TokenActivationCertificateThumbprint);
    result.extract(index, "TokenActivationGrantNumber",
                   (*this).TokenActivationGrantNumber);
  ...
  static std::string getWmiClassName() { return "SoftwareLicensingService"; }
...
struct Win32_LogicalDisk {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "InstallDate", (*this).InstallDate);
    result.extract(index, "LastErrorCode", (*this).LastErrorCode);
    result.extract(index, "MaximumComponentLength",
    ...
    result.extract(index, "SupportsFileBasedCompression",
  ...
  static std::string getWmiClassName() { return "Win32_LogicalDisk"; }
...
struct Win32_DiskDrive {
  ...
  static std::string getWmiClassName() { return "Win32_DiskDrive"; }
...
struct Win32_OperatingSystem {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "DataExecutionPrevention_Available",
                   (*this).DataExecutionPrevention_Available);
    result.extract(index, "DataExecutionPrevention_Drivers",
                   (*this).DataExecutionPrevention_Drivers);
    ...
    result.extract(index, "ForegroundApplicationBoost",
                   (*this).ForegroundApplicationBoost);
    result.extract(index, "FreePhysicalMemory", (*this).FreePhysicalMemory);
    result.extract(index, "FreeSpaceInPagingFiles",
    ...
    result.extract(index, "PortableOperatingSystem",
    ...
    result.extract(index, "SerialNumber", (*this).SerialNumber);
    result.extract(index, "ServicePackMajorVersion",
                   (*this).ServicePackMajorVersion);
    result.extract(index, "ServicePackMinorVersion",
                   (*this).ServicePackMinorVersion);
    result.extract(index, "SizeStoredInPagingFiles",
    ...
    result.extract(index, "TotalVirtualMemorySize",
                   (*this).TotalVirtualMemorySize);
    result.extract(index, "TotalVisibleMemorySize",
                   (*this).TotalVisibleMemorySize);
    result.extract(index, "Version", (*this).Version);
    result.extract(index, "WindowsDirectory", (*this).WindowsDirectory);
  }
  static std::string getWmiClassName() { return "Win32_OperatingSystem"; }
...
struct Win32_NetworkAdapter {
  ...
  static std::string getWmiClassName() { return "Win32_NetworkAdapter"; }
...
struct Win32_VideoController {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    result.extract(index, "AcceleratorCapabilities",
    ...
    result.extract(index, "CurrentHorizontalResolution",
                   (*this).CurrentHorizontalResolution);
    result.extract(index, "CurrentNumberOfColors",
                   (*this).CurrentNumberOfColors);
    result.extract(index, "CurrentNumberOfColumns",
    ...
    result.extract(index, "CurrentVerticalResolution",
                   (*this).CurrentVerticalResolution);
    result.extract(index, "Description", (*this).Description);
    result.extract(index, "DeviceID", (*this).DeviceID);
    ...
    result.extract(index, "InstallDate", (*this).InstallDate);
    result.extract(index, "InstalledDisplayDrivers",
    ...
    result.extract(index, "PowerManagementSupported",
                   (*this).PowerManagementSupported);
    result.extract(index, "ProtocolSupported", (*this).ProtocolSupported);
    result.extract(index, "ReservedSystemPaletteEntries",
  ...
  static std::string getWmiClassName() { return "Win32_VideoController"; }
...
struct Win32_BaseBoard {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "Removable", (*this).Removable);
    result.extract(index, "Replaceable", (*this).Replaceable);
    result.extract(index, "RequirementsDescription",
                   (*this).RequirementsDescription);
    result.extract(index, "RequiresDaughterBoard",
                   (*this).RequiresDaughterBoard);
    result.extract(index, "SerialNumber", (*this).SerialNumber);
    result.extract(index, "SKU", (*this).SKU);
  ...
  static std::string getWmiClassName() { return "Win32_BaseBoard"; }
...
struct UWF_Filter {
  ...
  static std::string getWmiClassName() { return "UWF_Filter"; }
  static std::string getWmiPath() { return "standardcimv2\\embedded"; }
...
struct AntiVirusProduct {
  ...
  void setProperties(const WmiResult& result, std::size_t index) {
    ...
    result.extract(index, "PathToSignedProductExe",
                   (*this).PathToSignedProductExe);
    result.extract(index, "PathToSignedReportingExe",
                   (*this).PathToSignedReportingExe);
    result.extract(index, "ProductState", (*this).ProductState);
    result.extract(index, "Timestamp", (*this).Timestamp);
  }

  static std::string getWmiClassName() { return "AntiVirusProduct"; }
  static std::string getWmiPath() { return "securitycenter2"; }
